...
PINNED_METRIC_NAMES: frozenset[str] = frozenset(
    {
        ...
        "fking_execution_rate_budget_refusals_total",
        ...
        "fking_execution_request_weight_utilisation_ratio",
        ...
        "fking_risk_asset_risk_share_ratio",
        "fking_risk_beta_to_btc_ratio",
        "fking_risk_beta_to_btc_sample_observations_count",
        "fking_risk_cluster_risk_share_ratio",
        ...
        "fking_risk_historical_var_sample_observations_count",
        "fking_risk_kill_switch_engaged_count",
        "fking_risk_limit_utilisation_ratio",
        "fking_risk_portfolio_drawdown_ratio",
        "fking_risk_portfolio_volatility_ratio",
        "fking_risk_position_notional_usd",
        "fking_risk_veto_total",
        "fking_risk_volatility_sample_observations_count",
        "fking_risk_volatility_to_target_ratio",
